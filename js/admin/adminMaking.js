...
function price()
{
	...
	if(id == "1"){	
		var commission = (parseInt($("#price_making").val())*commission_percentage)/100;
		total_sale = parseInt($("#price_making").val());

		$("#txtComission").text("$0");
		$("#txtTotal").text("$" + total_sale);
		$(".hdn_price_rent").val(total_sale);
	}
	else{
		
		var commission = (parseInt($("#price_making").val())*commission_percentage)/100;
		total_sale = parseInt($("#price_making").val()) + commission;

		$("#txtComission").text("$" + commission);
		$("#txtTotal").text("$" + total_sale);
		$(".hdn_price_rent").val(total_sale);
	}
}
