...
function viewSize()
{
	...
	var html_size = "<option value='0' data-iprice='0' data-istock='0' data-image=''>"+txtDefaultSelectSize+"</option>";
...
function valSchedule()
{
	...
	{
		$("#idProduct_rent").addClass("errorContat");		send = false;
	}
	else if($("#idColor_rent option:selected").val() == "0")
	{
		$("#idColor_rent").addClass("errorContat");			send = false;
	}
	else if($("#idSize_rent option:selected").val() == "0")
	{
		$("#idSize_rent").addClass("errorContat");			send = false;
	}
	else if($("#ine").val() == "")
	{
	...
	else if($("#vAdvance").val() == "")
	{
		$("#vAdvance").addClass("errorContat");				send = false;
	}
	else if(parseInt($("#vAdvance").val()) < parseInt($(".hdn_advance_rent").val()))
	{
		$("#vAdvance").addClass("errorContat");				send = false;
	}
...
function valMaking()
{
	...
	{
		$("#rangeMin_making").addClass("errorContat");		send = false;
	}
...
function valPrice()
{
	...
	subtotal = parseInt($("#idSize_rent option:selected").attr("data-iprice"));
	...
	if(id == "1"){	
		...
		$(".txtCommission").text("");
		$(".txtMinPrice").text(minAdvance);
		$(".hdn_advance_rent").val(minAdvance);
	}
	else{
