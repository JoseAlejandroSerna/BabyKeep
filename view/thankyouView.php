<html lang="en" class="">
    ...
    <body id="index" class="lang-en country-us currency-usd layout-full-width page-index tax-display-disabled body-desktop-header-style-w-3">
        ...
        <main id="main-page-content">
            <style> #header{top: 0!important;}</style>
                                                ...
                                                <div class="elementor-column elementor-element elementor-element-xzdikoc elementor-col-100 elementor-top-column" data-element_type="column">
                                                    <div class="elementor-column-wrap elementor-element-populated">
                                                        <div class="elementor-widget-wrap">
                                                            <div class="elementor-widget elementor-element elementor-element-uvymzjv elementor-widget-heading animated" data-animation="fadeIn" data-element_type="heading">
                                                                <div class="elementor-widget-container">
                                                                    <h4 class="elementor-heading-title elementor-size-default none">
                                                                        <span><?php echo $info_thankyouContact["seccion1_title"]; ?></span>
                                                                    </h4>        
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="elementor-container elementor-column-gap-no">
                                                                    <div class="elementor-row">
                                                                        <div class="elementor-column elementor-element elementor-element-bdzq7gt elementor-col-50 elementor-inner-column" data-element_type="column">
                                                                            <div class="elementor-column-wrap elementor-element-populated">
                                                                                <div class="elementor-widget-wrap">
                                                                                    <div class="elementor-widget elementor-element elementor-element-ewnfa9t elementor-widget-text-editor animated" data-animation="fadeIn" data-element_type="text-editor">
                                                                                        <div class="elementor-widget-container">
                                                                                            <div class="elementor-text-editor rte-content">
                                                                                                <p><?php echo $info_thankyouContact["seccion1_subtitle"]; ?></p>
                                                                                                <a href="<?php echo $helper->url("Main","index"); ?>" class="elementor-button-link elementor-button btn elementor-size-medium btn-secondary btn-traditional">
                                                                                                    <span class="elementor-button-content-wrapper">
                                                                                                        <span class="elementor-button-text"><?php echo $info_thankyouContact["seccion1_button"]; ?>.</span>
                                                                                                    </span>
                                                                                                </a>
                                                                                            </div>
                                                                                        </div>
