        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutMain_content">
                <main>
                    <div class="pb-10  bg-lineGradient">
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-top4">
                                <h2 class="h4 mb-0 pageH1 ">Reporte de rentas</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
					<form method="post" class="row" action="<?php echo $helper->url("AdminReportRent","update"); ?>" style="display:none;">
					...
					<form method="post" class="row" action="<?php echo $helper->url("AdminReportRent","delete"); ?>" style="display:none;">
                                								...
                                								<div class="modal-body">
                                									<div class="row">
                                                            			<div class="col-12 mb-3">
                                                                			...
                                                                			<p style="display:none">Hora: <b id="hora"></b></p>
                                                                			...
                                                                			<p>Fecha de regreso: <b id="fechaRegreso"></b></p>
                                                            			</div>
