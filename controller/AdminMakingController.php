<?php
class AdminMakingController extends ControladorBase{
    public $conectar;
	public $adapter;
    ...
    public function create(){
        ...
        $advance = "0";
        if($_POST["advance_making"] != ""){ $advance = $_POST["advance_making"];}
        ...
        foreach($info_notifications as $notification) {
            ...
            $iMaking = $notification->iMaking + 1;
        }
